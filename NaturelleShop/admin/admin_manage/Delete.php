            ...
            <form method="post" action="process_delete.php">
                <table class="tble1">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT id, username, full_name, created_at, email 
                        FROM admin 
                        WHERE username != 'root';
                        ";
                        ...
                        if (count($rows) > 0) {
                            foreach ($rows as $row) {
                                ...
                                $rowsrole = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                if (count($rowsrole) > 0) {
                                    echo "<td>";
                                    foreach ($rowsrole as $rowrole) {
                                        echo "<p class='status delivered'>" . htmlspecialchars($rowrole["name"]) . "</p> <br>";
                                    }
                                    echo "</td>";
                                } else {
                                    echo "<td></td>";
                                ...
                                echo "<input type='checkbox' name='delete_ids[]' value='" . htmlspecialchars($id) . "'>";
                ...
                <div class="submit-button-container">
                    <button type="submit" name="delete" class="submit-button">Delete Selected</button>
                </div>
            </form>
        </section>
    </main>
