...
<?php if ($existe != ''): ?>
  <div class="grid-container">
    ...
    <aside id="sidebar">
      <div class="sidebar-title">
        <div class="sidebar-brand">
          <span class="material-icons-outlined">local_shipping</span> Manage
        </div>
      ...
      <ul class="sidebar-list">
       <li class="sidebar-list-item">
        ...
        <li class="sidebar-list-item" >
            <a href="ajouter.php" target="description">
              <span class="material-icons-outlined">add</span> ADD
            </a>
        </li>
        <li class="sidebar-list-item" >
            <a href="delete.php" target="description">
    ...
    <main class="main-container has-scrollbar" id="main">
      <iframe src="Shippers.php" name="description" width="100%" height="100%" class="iframe" style="margin: 0;padding: 0;border:none"></iframe>
    </main>
    <!-- End Main -->
