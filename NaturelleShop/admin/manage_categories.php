...
if (isset($_SESSION['user_id']) && isset($_SESSION['admin_username'])) {
  ...
  if (count($rows) > 0) {
    foreach ($rows as $row) {
      if ($row["name"] === 'gestion des categories'  ) {
        $existe = 'existe';
        break;
      }
    }
...
<?php if ($existe != ''): ?>
  <div class="grid-container">
    ...
    <aside id="sidebar">
      ...
      <ul class="sidebar-list">
       <li class="sidebar-list-item">
        ...
        <li class="sidebar-list-item">
          <a href="categorie_manage/addcategorie.php" target="description">
            <span class="material-icons-outlined">add_circle</span> Add 
          </a>
        </li>
        <li class="sidebar-list-item">
          <a href="categorie_manage/UPDATEcategorie.php" target="description">
            <span class="material-icons-outlined">update</span> Update
          </a>
        </li>
        <li class="sidebar-list-item">
          <a href="categorie_manage/delete.php" target="description">
            <span class="material-icons-outlined">delete</span> DELETE
          </a>
        </li>
        <li class="sidebar-list-item">
            <a href="categorie_manage/geaphe.php" >
    ...
    <main class="main-container has-scrollbar" id="main">
      <iframe src="categorie_manage/dashboardcategorie.php" name="description" width="100%" height="100%" class="iframe" style="margin: 0;padding: 0;border:none"></iframe>
    </main>
    <!-- End Main -->
