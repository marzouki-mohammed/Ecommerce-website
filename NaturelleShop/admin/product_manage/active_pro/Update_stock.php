...
<body>
    <main class="table">
        ...
        <section class="table__body">
            <form method="post" action="prooss.php">
                <table class="tble1">
                    <thead>
                        <tr>
                        ...
                        try {
                            ...
                            if (count($rows) > 0) {
                                foreach ($rows as $row) {
                                    ...
                                    echo "<input type='radio' name='ids_components' value='" . htmlspecialchars($row["id"]) . "'>";
                ...
                <div class="submit-button-container">
                    <button type="submit" name="select_Components" class="submit-button">Sélectionner</button>
                </div>
            </form>
        </section>
    </main>
