...
<body>
    <main class="table">
        ...
        <section class="table__body">
            <form method="post" action="pross_Update_status.php">
                <table class="tble1">
                    <thead>
                        <tr>
                            ...
                            <th>Fournisseur Id <span class="icon-arrow">&UpArrow;</span></th>
                        ...
                        try {
                            ...
                            if (count($rows) > 0) {
                                foreach ($rows as $row) {
                                    ...
                                    echo "<input type='checkbox' name='select_id_Update_status[]' value='" . htmlspecialchars($row["id"]) . "' aria-label='Supprimer catégorie " . htmlspecialchars($row["product_name"]) . "'>";
                ...
                <div class="submit-button-container">
                    <button type="submit" name="Update_status" class="submit-button">Sélectionner</button>
                </div>
            </form>
        </section>
    </main>
