...
<body>
    <main class="table">
        ...
        <section class="table__body">
            <form method="post" action="prossselecton.php">
                <table class="tble1">
                    <thead>
                        <tr>
                        ...
                        try {
                            ...
                            if (count($rows) > 0) {
                                foreach ($rows as $row) {
                                    ...
                                    echo "<input type='radio' name='select_id_pro' value='" . htmlspecialchars($row["id"]) . "'>";
                ...
                <div class="submit-button-container">
                    <button type="submit" name="selectpro" class="submit-button">Sélectionner</button>
                </div>
            </form>
        </section>
    </main>
