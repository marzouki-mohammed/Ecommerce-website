...
<body>
    <main class="table">
        ...
        <section class="table__body">
            <form method="post" action="prossComposer2.php">
                <table class="tble1">
                    <thead>
                        <tr>
                        ...
                        try {
                            ...
                            if (count($rows) > 0) {
                                foreach ($rows as $row) {
                                    ...
                                    echo "<input type='checkbox' name='pro_ids[]' value='" . htmlspecialchars($id) . "'>";
                ...
                <div class="submit-button-container">
                    <button type="submit" name="selectecomposer" class="submit-button">Select</button>
                </div>
            </form>
        </section>
    </main>
