...
<?php if ($existe != ''): ?>
  <div class="grid-container">
    ...
    <aside id="sidebar">
      <div class="sidebar-title">
        <div class="sidebar-brand">
          <span class="material-icons-outlined">shield_person</span> Admin
        </div>
      ...
      <ul class="sidebar-list">
       <li class="sidebar-list-item">
          <a href="manage_admin.php">
            <span class="material-icons-outlined">dashboard</span> Dashboard Admin
          </a>
        </li>
        <li class="sidebar-list-item">
          <a href="admin_manage/add.php" target="description">
            <span class="material-icons-outlined">group_add</span> Add Admin
          </a>
        </li>
        <li class="sidebar-list-item">
          <a href="admin_manage/Delete.php" target="description">
            <span class="material-icons-outlined">person_remove</span> Delete Admin
          </a>
        </li>
        <li class="sidebar-list-item">
          <a href="admin_manage/role.php" target="description">
            <span class="material-icons-outlined">apps</span> Role
          </a>
        </li>
        <li class="sidebar-list-item" >
    ...
    <main class="main-container has-scrollbar" id="main">
      ...
      <iframe src="admin_manage/dashboardAdmin.php" name="description" width="100%" height="100%"  style="margin: 0;padding: 0;border:none"></iframe>
